...
Revision ID: 4574c66124b7
Revises: 
Create Date: 2025-12-24 17:17:09.249519
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('block_id', 'position', name='uix_block_exercise_position')
    )
